      ...
      <div className="container py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-10">
          ...
          <div className="lg:col-span-2">
            <img
              src="/casadf-logo.png"
              alt="Casa DF Gestão Imobiliária"
              className="h-14 w-auto mb-4 object-contain"
            />
            <p className="text-sm text-white/80 mb-5 leading-relaxed max-w-xs">
              Plataforma de gestão imobiliária inteligente e completa para compra, venda e locação de imóveis, oferecendo clareza, organização e suporte consultivo em todo o processo.
            </p>
            <p className="text-xs text-white/50 mb-5 leading-relaxed max-w-xs italic">
              Gestão de imóveis com foco em transparência, estratégia e agilidade para quem busca a melhor experiência no mercado imobiliário.
            </p>
        ...
        <div className="border-t border-white/20 pt-8">
          ...
          <div className="bg-white/10 rounded-xl p-5 mb-6">
            <p className="text-xs text-white/80 leading-relaxed">
              <strong>Aviso Legal:</strong> A Casa DF atua como <strong>assessoria imobiliária e empresarial, incluindo intermediação de imóveis e captação de recursos e crédito para empresas</strong>. A concessão final do crédito é de responsabilidade exclusiva da instituição financeira parceira, e a efetivação de negócios imobiliários depende da anuência das partes envolvidas e, quando aplicável, de análise documental e financeira. As condições de crédito, taxas de juros e prazos variam conforme perfil do cliente e análise de crédito. Sujeito à análise e aprovação. <strong>Os valores apresentados são estimativas para fins de simulação e podem variar conforme análise de crédito, documentação, perfil do cliente, garantia oferecida e condições vigentes da instituição financeira no momento da contratação.</strong>
            </p>
          </div>

          {/* Links Legais e Copyright */}
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/60">
            <p>© {currentYear} Casa DF. Todos os direitos reservados.</p>
