...
import ImoveisAdmin from "./pages/colaborador/ImoveisAdmin";
import ImovelForm from "./pages/colaborador/ImovelForm";
import FichaVisitaAdmin from "./pages/colaborador/FichaVisitaAdmin";
import ContratosImobiliarios from "./pages/colaborador/ContratosImobiliarios";
import ConfiguracoesImobiliarias from "./pages/colaborador/ConfiguracoesImobiliarias";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/imoveis/:idOrSlug" component={ImovelDetalhe} />
      ...
      <Route path="/colaborador/imoveis/novo">
        {() => (
          <ProtectedRoute>
            <ImovelForm />
          </ProtectedRoute>
      ...
      <Route path="/colaborador/imoveis/:id/editar">
        {() => (
          <ProtectedRoute>
            <ImovelForm />
          </ProtectedRoute>
      ...
      <Route path="/colaborador/imoveis">
        {() => (
          <ProtectedRoute>
            <ImoveisAdmin />
          </ProtectedRoute>
      ...
      <Route path="/colaborador/imovel-visitas">
        {() => (
          <ProtectedRoute>
            <FichaVisitaAdmin />
          </ProtectedRoute>
      ...
      <Route path="/colaborador/contratos-imobiliarios">
        {() => (
          <ProtectedRoute>
      ...
      <Route path="/colaborador/configuracoes-imobiliarias">
        {() => (
          <ProtectedRoute>
            <ConfiguracoesImobiliarias />
          </ProtectedRoute>
        )}
      </Route>
