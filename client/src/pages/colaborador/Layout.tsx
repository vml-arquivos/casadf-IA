...
const ALL_NAV_ITEMS: NavItem[] = [
  ...
  { href: "/colaborador/imoveis",     label: "Imóveis",            icon: Home },
  { href: "/colaborador/imovel-visitas", label: "Fichas de Visita", icon: ClipboardList },
  { href: "/colaborador/contratos-imobiliarios", label: "Contratos Imobiliários", icon: FileSignature },
  { href: "/colaborador/configuracoes-imobiliarias", label: "Config. Imobiliárias", icon: Settings },
